...
MANAGER_DIRECTORY = {
    "Emergency": {
        ...
        "dept_head": "Dr. Robert Chen",
        "dept_head_email": "r.chen@hospital.com",
    },
    "Cardiology": {
        "manager_id": "MGR-002",
        ...
        "dept_head": "Dr. Amelia Singh",
        "dept_head_email": "a.singh@hospital.com",
    },
    "Orthopedics": {
        "manager_id": "MGR-003",
        "name": "Dr. Lisa Nguyen",
        "email": "l.nguyen@hospital.com",
        "phone": "+91-9900001003",
        "notification_pref": "push+email",
        "dept_head": "Dr. Marcus Williams",
        "dept_head_email": "m.williams@hospital.com",
    },
    "Pediatrics": {
        "manager_id": "MGR-004",
        ...
        "phone": "+91-9900001004",
        "notification_pref": "push",
        "dept_head": "Dr. Fatima Al-Rashid",
        "dept_head_email": "f.alrashid@hospital.com",
    },
    "General Medicine": {
        "manager_id": "MGR-006",
        ...
        "phone": "+91-9900001006",
        "notification_pref": "push+email",
        "dept_head": "Dr. Helen Morris",
        "dept_head_email": "h.morris@hospital.com",
    },
    "Neurology": {
        "manager_id": "MGR-005",
        ...
        "dept_head": "Dr. Ivan Petrov",
        "dept_head_email": "i.petrov@hospital.com",
    },
}
